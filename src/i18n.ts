...
const en = {
	...
	usageSemantic: "Usage: /kb semantic [status | api [base-url] [model] | local | off]",
	...
	subcommands: {
		...
		semantic: "Semantic search: /kb semantic [status | api | local | off]",
...
const zh: Messages = {
	...
	usageSemantic: "用法：/kb semantic [status | api [接口地址] [模型] | local | off]",
	...
	subcommands: {
		...
		semantic: "语义检索：/kb semantic [status | api | local | off]",
