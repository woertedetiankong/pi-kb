...
const en = {
	...
	projectStatus: (name: string, docs: number, notes: number, dir: string) => `Project knowledge base "${name}" (shared through git): ${docs} docs · ${notes} notes · ${dir}`,
	...
	subcommands: {
		...
		move: "Move a document or note between the project and your global knowledge base: /kb move <id> project | global",
		...
		sync: "Re-read the folder: notes edited by hand, or documents and notes from another computer or a teammate",
